...
pygame.display.set_caption("FS Simulation")
...
# Drawing of fidget spinner on window
def show_spinner(angle, color, dark_color):
	...
	pygame.draw.ellipse(display, dark_gray, tuple(top_inner))
	pygame.draw.ellipse(display, color, tuple(left))
	pygame.draw.ellipse(display, dark_gray, tuple(left_inner))
	pygame.draw.ellipse(display, color, tuple(right))
	pygame.draw.ellipse(display, dark_gray, tuple(right_inner))
